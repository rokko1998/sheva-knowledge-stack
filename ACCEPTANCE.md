...
| F. Seven AI Brain buckets | Current canonical rendering; only changed buckets refreshed | Seven ready sources observed, canonical fulltext verified; only DECISIONS refreshed after one note changed. A newer DECISIONS write awaits a network retry. |
